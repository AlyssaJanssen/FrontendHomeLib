...
<template>
  <div>
    <h1 class="container grid justify-center mt-8">
      Welcome to your profile
    </h1>
    <div v-if="user.isLoggedIn" class="text-center container grid justify-center">
      ...
      <p class="text-neutral-600 dark:text-neutral-400">Home Lib user</p>
    </div>
  </div>
</template>

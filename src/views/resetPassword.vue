<template>
  <div class="text-center container grid justify-center mt-20">
    ...
    <form class="space-y-6" action="#" @submit.prevent="sendResetEmail">
      <div>
        <label for="email"
          class="flex mt-2 text-sm font-medium text-gray-900 dark:text-white items-start justify-start">Email</label>
        <input type="email" name="email" id="email"
          ...
          placeholder="Enter Your HomeLib email" required v-model="email" />
        <button type="submit"

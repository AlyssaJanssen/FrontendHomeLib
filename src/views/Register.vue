    ...
    <div
      ...
      <form class="space-y-6" action="#" autocomplete="off" @submit.prevent="Register">
        ...
        <div>
          ...
          <input autocomplete="off" readonly onfocus="this.removeAttribute('readonly');" type="email" name="email"
            id="email"
        ...
        <div>
          ...
          <input type="password" name="password" id="password" placeholder="••••••••"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
            required v-model="password" autocomplete="off" />
        </div>
        <div>
        ...
        <div class="text-sm font-medium text-gray-500 dark:text-gray-300">
          Already a member?
          <RouterLink to="/login" class="text-sky-700 hover:underline dark:text-sky-500">Login to your account
          </RouterLink>
        </div>
      </form>
    </div>

  ...
  >
    <!-- <div class="relative block h-32 lg:col-span-2 lg:h-full">
     <p class="m-32"></p>
      ...
      >
        <svg class="fill-current w-24 h-24 sm:w-24 sm:h-24" viewBox="0 0 24 24">
          <path
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div>
            <p class="font-medium text-lg text-gray-900 dark:text-white">HomeLib</p>
              <i class="fa-solid fa-book mr-1 text-xl"> </i>  <i class="fa-solid fa-mug-hot m-1 text-xl"> </i> 
                ...
                <li>
                  <RouterLink to="/register">
                    <button
                      ...
                      class="transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300 text-sm bg-sky-600 border border-sky-500 text-white font-bold py-2 px-4 rounded-lg"
                    >
                      Sign Up
                    </button>
                  </RouterLink>
